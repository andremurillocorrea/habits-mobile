  ...
  return (
    <View className="flex-1 bg-background px-8 pt-16">
      ...
      >
        ...
        <TextInput 
          className="h-12 pl-4 bg-zinc-900 text-white rounded-lg mt-3 border-2 border-zinc-800  focus:border-green-600"
        ...
        <TouchableOpacity 
          activeOpacity={0.7}
          className="bg-green-600 w-full h-14 flex-row items-center justify-center rounded-md mt-6"
